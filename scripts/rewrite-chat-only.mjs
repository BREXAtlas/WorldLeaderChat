...
Write 10–14 messages that feel like an organic group chat among people or institutions naturally connected to this exact event. Keep every message concise at 10–35 words. Start in the middle of a reaction—a position, challenge, contradiction, pointed question or joke. The first message must be a direct participant message, never UN Admin, Admin, a narrator or a system message. Use direct first-person replies, interruptions and callbacks; at least two speakers must return. Every line must respond to the actual people, act, number, place, object or consequence in this article.
